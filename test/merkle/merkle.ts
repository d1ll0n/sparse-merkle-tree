...
import { SparseMerkleTreeImpl } from '../../src/merkle-tree'
import { BaseDB } from '../../src/app/db/db';
import {
  HashFunction,
  MerkleTree,
  ...
  MerkleUpdate,
  SparseMerkleTree,
} from '../../src/types-needed/utils'
import {
  DB
} from '../../src/types-needed'
import {
  BigNumber,
  keccak256,
  ONE,
...
// const { BaseDB } = require('../build/app/db')
